...
|------|--------|-----|-----------|
| <img src="/Recursos/Imagenes/Angelo Arreche.png" width="90"/> | **Angello Areche Espeza** | Técnico de Hardware y Prototipos | Diseña, integra y ensambla el prototipo físico del sistema. Se encarga de la selección, conexión y validación de los componentes electrónicos, realizando pruebas de funcionamiento para garantizar la correcta operación del dispositivo. |
| <img src="/Recursos/Imagenes/Rolando Ronceros.png" width="90"/> | **Rolando Ronceros Huaynapomas** | Diseñador de Arquitectura del Sistema | Define la arquitectura general del proyecto, estableciendo la interacción entre los módulos de hardware y software. Diseña el flujo de funcionamiento del sistema y asegura una integración eficiente entre todos los componentes. |
| <img src="/Recursos/Imagenes/Leslie Tomanguilla.png" width="90"/> | **Leslie Stephany Tomanguilla Huaman** | Analista Funcional del Sistema | Analiza la problemática y define los requerimientos funcionales del sistema. Establece las funcionalidades principales y verifica que la solución propuesta responda a las necesidades de las personas con discapacidad visual. |
| <img src="/Recursos/Imagenes/Daniela Mori.png" width="90"/> | **Daniela Mori Mendoza** |  Gestora de Documentación | Organiza, redacta y mantiene actualizada toda la documentación del proyecto. Gestiona los informes, la documentación técnica, el repositorio GitHub y el registro de avances para garantizar claridad y organización de la información. |
| <img src="/Recursos/Imagenes/Alex Ccoyllo.png" width="90"/> | **Alex Jhosep Ccoyllo Sotelo** | Desarrollador de Sistemas Embebidos | Implementa la lógica de funcionamiento del sistema, integrando el procesamiento de datos provenientes de los sensores y la cámara. Desarrolla las funciones necesarias para la detección del entorno y la generación de alertas por voz, asegurando la comunicación entre los módulos del sistema. |
